    ...
    <>
      <section aria-labelledby="current-billing-cycle">
        <h1
          ...
          className="scroll-mt-10 text-lg font-semibold text-fg sm:text-xl"
        >
      ...
      <section aria-labelledby="usage-overview">
        <h1
          id="usage-overview"
          className="mt-16 scroll-mt-8 text-lg font-semibold text-fg sm:text-xl"
        >
          Overview
        </h1>
        <div className="sticky top-16 z-20 flex items-center justify-between border-b border-border bg-surface pb-4 pt-4 sm:pt-6 lg:top-0 lg:mx-0 lg:px-0 lg:pt-8">
          <Filterbar
            maxDate={maxDate}

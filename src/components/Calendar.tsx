  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "w-9 font-medium text-sm sm:text-xs text-center text-fg-muted pb-2",
        row: "w-full mt-0.5",
        cell: cx(
        ...
        day: cx(
          "size-9 rounded text-sm text-fg focus:z-10",
        ...
        day_disabled:
          "!text-fg-muted line-through disabled:hover:bg-transparent",
        day_outside: "text-fg-muted",
        day_range_middle: cx(
          "!rounded-none",
          ...
          return (
            <div className="flex items-center justify-between">
              ...
              <div
                role="presentation"
                aria-live="polite"
                className="text-sm font-medium capitalize tabular-nums text-fg"
              >
